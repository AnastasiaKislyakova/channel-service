...
import ru.kislyakova.anastasia.channelmodel.entity.Error;
import ru.kislyakova.anastasia.channelservice.exception.SchedulerApiException;

import java.util.List;
import java.util.stream.Collectors;

@RestControllerAdvice(basePackages = "ru.kislyakova.anastasia.channelservice.controller")
